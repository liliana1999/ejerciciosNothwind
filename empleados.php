...
$consulta = mysqli_query($conn,"Select * from empleados");
...
echo "<Table border='1'>";
echo "<tr>";
echo "<th>IdEmpleado</th><th>Apellido</th><th>Nombre</th>
<th>Cargo</th><th>Tratamiento</th><th>FechaNacimiento</th><th>FechaContratacion</th>
<th>Direccion</th><th>Ciudad</th><th>Region</th><th>CodigoPostal</th>";
echo "</tr>";
